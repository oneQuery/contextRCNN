...
# os.chdir('C:/Users/asses/Desktop/Dev/contextRCNN/models/research')
# print(os.getcwd())
...
print(faster_rcnn_model.output_dtypes)
print(faster_rcnn_model.output_shapes)
...
print(context_rcnn_model.output_dtypes)
print(context_rcnn_model.output_shapes)
